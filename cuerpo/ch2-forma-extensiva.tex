...
\textcolor{red}{\bf ***** Cuál es el valor del equilibro de Nash en Kuhn Poker? *****}
...
\end{example}
 ...
 La Figura \ref{fig:imperfect-recall} representa el juego en forma extensiva. 
 %Donde P representa la acción de parar el juego y C de continuarlo; $M$ representa la acción de mantener las cartas obtenidas inicialmente e $I$ representa la acción de intercambiar las cartas. 
...
Sea $s_i \in S_i$ una estrategia pura del jugador $i$ e $I_i \in \mathcal{I}$ un conjunto de información. Diremos que $I_i$ es alcanzable bajo $s_i$ si existe una historia $h \in H$ tal que $h \in I_i$, y para toda historia (prefijo) $h' \sqsubset h$, con $P(h') = i$, se tiene que $(h', s_i(h'))$ también es prefijo de $h$. \textcolor{red}{\bf ***** Esta definición no esta completa. Revisarla ****} 
\end{definition}
