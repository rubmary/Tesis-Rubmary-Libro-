...
Los procedimientos que calculan equilibrios correlacionados se basan en el método de aproximación de Blackwell \cite{bib:blackwell}. En este apéndice se muestra el teorema como es presentado en \cite{bib:correlated-equilibrium}.
...
Dado un conjunto convexo y cerrado $\mathcal{C}$ se denotará con $F(x)$ el punto (único) más cercano a $x$ de $C$, y con $\lambda(x)= x - F(x)$.
