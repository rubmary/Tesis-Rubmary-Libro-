...
\input{REORGANIZED/ch1-forma-normal}
\input{REORGANIZED/ch2-forma-extensa}
\input{REORGANIZED/ch3-evaluacion-explotabilidad}
\input{REORGANIZED/ch4-regret-matching}
\input{REORGANIZED/ch5-CFR}

%\input{capitulo-1/capitulo-1}
%\input{capitulo-2/capitulo-2}
%\input{capitulo-3/capitulo-3}
