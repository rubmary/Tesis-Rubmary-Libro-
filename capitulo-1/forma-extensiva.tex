...
\begin{figure}[ht]
\begin{center}
\caption{Juego de distribución. \Blai{**** Usar captions con explicación para que se entienda el contenido sin tener que ir al texto ****}}
...
\begin{figure}
\begin{center}
\caption{Ejemplo de juego con información incompleta. \Blai{**** Usar captions con explicación para que se entienda el contenido sin tener que ir al texto ****}}
...
\begin{figure}
\begin{center}
\caption{Árbol del juego de Kunh Poker. \Blai{**** Usar captions con explicación para que se entienda el contenido sin tener que ir al texto ****}}
...
\begin{figure}
\begin{center}
\caption{Árbol del juego de piedra, papel o tijera}
\label{fig:RPS}
\begin{tikzpicture}[
...
\Blai{*** Necesita hacerse mas claro. La notación tambien debe introducirse de forma mas adecuada. ****}
...
\begin{figure}[ht]
\begin{center}
\caption{Árbol del juego del Ejemplo \ref{ex:imperfect-recall}}
